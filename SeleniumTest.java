...
public class SeleniumTest implements SauceOnDemandSessionIdProvider {
     ...
     */
    public SauceOnDemandAuthentication authentication = new SauceOnDemandAuthentication("ashishsharma", "3abde8d0-d65c-4b96-992a-2f7d0881c802");
    ...
    public void setUp() throws Exception {
        ...
        capabillities.setCapability("version", "19");
    ...
    public void SeleniumTest() throws Exception {
        driver.get("http://qa.ringdna.com/");
        driver.findElement(By.xpath("html/body/div[3]/div/div[2]/a")).click();
        driver.findElement(By.xpath("//*[@id='username']")).sendKeys("demoqa01@ringdna.com");
        driver.findElement(By.xpath("//*[@id='password']")).sendKeys("ebmdna0198");
        driver.findElement(By.xpath("//*[@id='Login']")).click();
        driver.findElement(By.xpath("//*[@id='track']")).click();
        driver.findElement(By.xpath("//*[@id='main-nav']/ul/li[4]/ul/li[4]/a")).click();
  	String title = driver.findElement(By.xpath("//*[@id='header-title']")).getText();
		if (title.equals("URL Call Tracking"))
		{
			System.out.println("URL Call Tracking Wizard is opened");
			System.out.println("Test Case No.1 for Track URL is passed");
		}else {
			System.out.println("Test case is fail");
		}
		driver.findElement(By.xpath("//*[@id='userInfo']/p/a")).click();
    }
