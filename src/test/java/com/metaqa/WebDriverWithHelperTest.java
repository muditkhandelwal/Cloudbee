...
public class WebDriverWithHelperTest implements SauceOnDemandSessionIdProvider, SauceOnDemandAuthenticationProvider {
    ...
    @BeforeMethod
    public void setUp(@Optional("muditkhandelwal") String username,
                      @Optional("24c5e0ac-f10e-4b3b-8348-a0554243e069") String key,
        ...
        if (StringUtils.isNotEmpty(username) && StringUtils.isNotEmpty(key)) {
           ...
           authentication = new SauceOnDemandAuthentication("muditkhandelwal", "24c5e0ac-f10e-4b3b-8348-a0554243e069");
        }
